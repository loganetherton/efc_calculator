...
define ('K_PATH_MAIN', "$cwd/");

/**
 * URL path to tcpdf installation folder (http://localhost/tcpdf/).
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_URL', 'http://localhost/efc/Aristo/tcpdf/');
 ...
 */
define ('PDF_HEADER_LOGO', 'student_aid_calculate.jpg');
 ...
 * Document author.
 */
define ('PDF_AUTHOR', 'Logan Etherton');
